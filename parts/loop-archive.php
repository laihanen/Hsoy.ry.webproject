<article id="post-<?php the_ID(); ?>" <?php $post_class= get_post_class(); echo 'class="panel-main-page-article '; foreach ($post_class as $classy) { echo $classy . ' ';}; echo '"'; ?> role="article">					
