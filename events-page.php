<?php
/*
Template Name: Category Grouping Template (Tapahtumat)
*/
?>
...
<div id="content">
    <div id="inner-content" class="row">
        <main id="main" class="large-8 medium-8 columns" role="main">
            ...
            <?php    query_posts( array ( 'category_name' => 'Tapahtumat', 'posts_per_page' => 3 ) ); ?>
            ...
            <?php endwhile; else: ?>
                ...
                <div class="panel panel-grouping-page">
                    ...
                    <div class="panel-body">
                        <?php _e('Ei olla vielä keretty postamaan mitään.'); ?>
                    </div>
                </div>
            <?php endif; ?>
        </main>
